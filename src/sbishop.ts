...
export function checkConvergence(
  ...
  console.log(currentIteration, "currentIteration", maxIterations, "maxIterations");
  if (currentIteration >= maxIterations) {
    // If the maximum number of iterations is reached without convergence, return the current FoS.
    return initialGuessFOS;
  }
  ...
  if (Math.abs(nextFOS - initialGuessFOS) < tolerance) {
...
// 1. Name of slice - Represented as Slice, Not necessary for computation
// 2. Width of slice - Represented as dx
...
// 5. Internal angle of friction of the slice - Represented as theta
// 6. Weight of the slice - Represented as W
